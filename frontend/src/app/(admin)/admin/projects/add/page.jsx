...
import { ArrowLeft, X, Calendar, Plus, Upload, Link2Icon } from "lucide-react";
...
export default function ProjectForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await customFetch.post("/projects", form, {
  ...
  return (
    <div className="space-y-8 text-white">
      <div className="flex justify-between items-center border-b pb-6">
        <h1 className="text-3xl font-serif ">Add New Project</h1>
        <Link
          href="/admin/projects"
      ...
      <form className="space-y-8" onSubmit={handleSubmit}>
        ...
        <ActionButtons isLoading={isSaving} submitLabel="Create Project" />
      </form>
    </div>
  );
}
