...
import { JoditEditor, FileInput } from "@/components/admin/inputs";
...
export default function page() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSaving(true);
      await customFetch.post("/experience", formDataToSend, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });
      toast.success("Experience has been created.");
  ...
  return (
    <div className="space-y-8 mb-8 text-white">
      <div className="flex justify-between items-center border-b pb-6">
        <h1 className="text-3xl font-serif ">Add New Experience</h1>
        <Link
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <ActionButtons isLoading={saving} submitLabel="Create Experience" />
      </form>
    </div>
  );
}
