...
export default function SkillDetailsPage() {
  ...
  const { data: skillData, status } = useQuery({
    queryKey: ["skill", id],
    queryFn: async () => {
      const { data } = await customFetch(`/skills/${id}`);
      return data;
    },
  });
    ...
    <div className="py-24 container px-4 sm:px-6 lg:px-8  ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2">
          <div className=" rounded-2xl p-8 shadow-sm border-[1px] border-gray-700">
        ...
        <div className="space-y-6">
          ...
          {skill.difficultyLevel && (
            <div className="rounded-2xl p-6 shadow-sm border-[1px] border-gray-700">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-3 text-sm text-gray-600">
                  {skill.difficultyLevel || "Not specified"}
                </span>
              </div>
            </div>
          )}
